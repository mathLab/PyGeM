...
class TestVtkHandler(TestCase):
    ...
    def test_vtk_default_infile_member(self):
        ...
        assert vtk_handler.infile == None  # nosec  # nosec

    def test_vtk_default_outfile_member(self):
        vtk_handler = vh.VtkHandler()
        assert vtk_handler.outfile == None  # nosec  # nosec
    ...
    def test_vtk_parse_infile(self):
        ...
        assert (  # nosec  # nosec
            vtk_handler.infile == "tests/test_datasets/test_red_blood_cell.vtk"
        )
    ...
    def test_vtk_parse_shape(self):
        ...
        assert mesh_points.shape == (500, 3)  # nosec  # nosec
    ...
    def test_vtk_write_outfile(self):
        ...
        assert vtk_handler.outfile == outfilename  # nosec  # nosec
    ...
    def test_vtk_write_comparison(self):
        ...
        outfilename_expected = (
            "tests/test_datasets/test_red_blood_cell_out_true.vtk"
        )
