...
class NurbsHandler(fh.FileHandler):
    ...
    def write(self, mesh_points, filename, tolerance=None):
        ...
        while faces_explorer.More():
            ...
            mesh_points[i + control_point_position[n_faces], :]
          )
    ...
    def write_shape(self, l_shells, filename, tol):
        ...
        while shape_shells_explorer.More():
            per_shell = OCC.TopoDS.topods_Shell(shape_shells_explorer.Current())
            ...
            # cycle on faces
            faces_explorer = TopExp_Explorer(per_shell.Oriented(TopAbs_FORWARD),
                                             TopAbs_FACE)
            iface = 0
            while faces_explorer.More():
