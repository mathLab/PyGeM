...
class kHandler(fh.FileHandler):
        ...
        :cvar list extensions: extensions of the input/output files. It is equal to '.k'.
        """
        def __init__(self):
        ...
        def parse(self, filename):
            ...
            It reads only the section *NODE of the k files.
        ...
        def write(self, mesh_points, filename):
            """
            Writes a .k file, called filename, copying all the lines from self.filename but
